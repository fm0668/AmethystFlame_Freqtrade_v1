...
class Exchange:
    ...
    def __init__(
        ...
        *,
        ...
        if validate:
            if exchange_conf.get("offline_mode", False):
                self._init_offline_markets()
            else:
    ...
    def _init_offline_markets(self) -> None:
        ...
        for pair in pair_whitelist:
            ...
            market = {
                ...
                "margin": self.trading_mode == TradingMode.MARGIN,
                "swap": self.trading_mode == TradingMode.FUTURES,
                "linear": self.trading_mode == TradingMode.FUTURES,
                "contractSize": 1,
            }
            markets[pair] = market
